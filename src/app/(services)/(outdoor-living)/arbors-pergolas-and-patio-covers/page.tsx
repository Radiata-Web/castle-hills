...
export const metadata: Metadata = {
  title: "Arbors, Pergolas & Patio Covers | Castle Hills Stain & Restoration",
  description:
    "Arbor, pergola, and patio installation and staining services in the Dallas-Fort Worth Metroplex.",
}
  ...
  return (
    <>
      ...
      <section className="space-y-12 md:space-y-20">
        <ServiceDesc
          imagePosition="left"
          image="pergolas/pergola-5"
          imageAlt="Dark brown arbor attached to the back of a house against a blue cloudy sky"
